...
contract ResourceLocatorUtil is Script {
    ...
    function attachResourceLocatorToDiamond(address diamond) public {
        ...
        cuts[0] = IDiamondCut.FacetCut({
            ...
            functionSelectors: new bytes4[](47)
        });
        ...
        cuts[0].functionSelectors[44] = ResourceLocatorFacet.vrfClientWalletAddress.selector;
        cuts[0].functionSelectors[45] = ResourceLocatorFacet.setVRFClientWalletAddress.selector;
        cuts[0].functionSelectors[46] = ResourceLocatorFacet.importResourcesFromDiamond.selector;
